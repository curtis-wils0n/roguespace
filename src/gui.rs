use super::{
    CombatStats, Equipped, HungerClock, HungerState, InBackpack, Map, Name, Player, Position,
    RunState, State, Viewshed, gamelog::GameLog,
};
...
fn item_menu(gs: &mut State, ctx: &mut Rltk, title: &str) -> (ItemMenuResult, Option<Entity>) {
